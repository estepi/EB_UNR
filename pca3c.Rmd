...
Investigue sobre el diseño experimental y las principales prgeuntas biológicas del experimento 
...
* El mismo fue preparado usando la salida de alineamiento con STAR v 2.7 contra el genoma Mmu version ...
...
Usando el archivo selector.tsv, asigne la condición a cada muestra bajo estudio
...
* Realizar un análisis de clustering no supervisado para identificar grupos de genes de comportamiento similar
